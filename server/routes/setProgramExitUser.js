...
const controller = require('../controller/api/setProgramExitUser');
const { isExistToken, isActiveUser, isDeleteUser, isExistUser } = require('../middleware/api');
var checkAuth=[isExistToken,isExistUser,isActiveUser,isDeleteUser]

var router = express.Router();
router.post('/storeProgramExitUser',checkAuth, controller.POST_PROGRAM_EXIT_USER);
router.post('/storeProgramDeleteUser',checkAuth, controller.POST_PROGRAM_DELETE_USER);
