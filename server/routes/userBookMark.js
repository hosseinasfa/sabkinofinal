...
const controller = require('../controller/api/userBookMark');
...
router.get('/getList', checkAuth, controller.GET_ALL_BOOK_ITEM);
router.delete('/deleteItem', checkAuth, controller.DELETE_BOOK_ITEM);
