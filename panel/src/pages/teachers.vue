...
export default {
    ...
    this.table = {
      ...
      columns: [
        ...
        },
        {
          name: "isPeriodActive",
          align: "left",
          label: "وضعیت دسترسی دوره آنلاین",
          field: "isPeriodActive",
          format: (val) => (val ? "فعال" : "مسدود"),
          sortable: true,
        },
        {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .get("model/person-Teacher", { headers: config })
        .then((response) => {
    ...
    getList2() {
      ...
      this.$axios
        .get("model/person-Teacher", { headers: config })
        .then((response) => {
          var ress = response.data.data.items.reverse();
          const flp = ress.filter((e) => e.isConfirmed === false);
