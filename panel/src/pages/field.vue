...
export default {
    ...
    this.table= {
      ...
      form: [
        ...
        },
        {
          ...
          isObject: false,
          type: "q-input",
          label: "کلیات و تعاریف",
          model: "",
          canUpdate: true,
          isSecret: false,
          field: "generalitiesAndDefinitions",
        },
        {
          isFile: false,
          isObject: false,
        ...
        },
        {
          ...
          canUpdate: true,
          isSecret: false,
          field: "universityCourses",
        },
        {
          isFile: false,
          isObject: false,
          type: "q-input",
          label: "توانایی های مورد نیاز",
          model: "",
          canUpdate: true,
          isSecret: false,
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .get("model/field",{headers: config})
        .then((response) => {
