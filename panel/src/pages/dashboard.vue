      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <q-card>
          <q-card-section :class="$q.dark.isActive?'blue_dark':'bg-blue-8'" class="text-white">
            <div class="row">
              <div class="col-10">
                <div class="text-h6">سود فروش</div>
    ...
    <div class="row q-col-gutter-sm q-ma-xs">
      <div class="col-12">
        <q-card flat bordered class="bg-white">
          <q-table title="All Activities" :data="data" :hide-header="mode === 'grid'" :columns="columns" row-key="name"
  ...
  export default {
    ...
    data() {
      return {
        ...
        date: '1399/09/20 22:00',
        proxyDate: '1399/09/20 22:00',
        filter: '',
        mode: 'list',
      ...
      barOptions() {
        return {
          ...
          dataset: {
            ...
            source: [{
                time_period: 'Jan 2019',
                sale: 50,
                goal: 70
              },
              {
                time_period: 'Feb 2019',
                sale: 80,
                goal: 75
              },
              {
                time_period: 'Mar 2019',
                sale: 86,
                goal: 80
              },
              {
                time_period: 'Apr 2019',
                sale: 72,
                goal: 85
              }
            ]
