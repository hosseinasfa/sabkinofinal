    ...
    getList() {
      ...
      this.$axios
        ...
        .then((response) => {
            ...
            var Fres = res.filter(e => e.type === "channel");
            // var Fress = Fres.find(e => e.channelId);
            // var FRitemId = Fress.channelId._id
             console.log(Fres) 
