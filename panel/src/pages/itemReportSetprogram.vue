...
export default {
  ...
  mounted() {
    this.table = {
      ...
      title: `لیست گزارشات برنامه دادن `,
      filter: "",
      mode: "list",
      url: `model/setProgramListReport`,
      columns: [
        {
          name: "index",
          label: "#",
        ...
        },
        {
          ...
          field: (row) => row.mentorIdReport.firstName,
          sortable: true,
        },
        {
          name: "lastName",
          ...
          field: (row) => row.mentorIdReport.lastName,
          sortable: true,
        },
        {
          name: "lastName",
          ...
          field: (row) => row.mentorIdReport.class === "user" ? "دانش آموز" : row.mentorIdReport.class === "mentor" ? "مشاور" : row.mentorIdReport.class === "teacher" ? "معلم" : row.mentorIdReport.class === "family" ? "خانواده" : row.mentorIdReport.class === "schoolBoss" ? "مدیر مدرسه" : "",
          sortable: true,
        },
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .get("model/setProgramListReport",{headers: config})
        .then((response) => {
