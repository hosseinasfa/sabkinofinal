...
export default {
  ...
  mounted() {
    this.table= {
      ...
      readonly:false,
      hasSubset:true,
      subsetUrl:`/publisher/${this.$route.params.itemId}/:id`,
      title: "لیست سری ها",
      filter: "",
      mode: "list",
      url: `model/publisherSeries`,
      query:{
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .get(`model/publisherSeries/search/publisherId=${this.$route.params.itemId}`,{headers: config})
        .then((response) => {
