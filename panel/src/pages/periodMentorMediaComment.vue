...
export default {
  ...
  mounted() {
    this.table = {
      ...
      readonly: true,
      hasSubset: false,
      subsetUrl: '/periodMentorMediaComment/:id',
      title: "لیست کامنت های جلسات",
      filter: "",
      mode: "list",
      url: `periodMentorMediaComment`,
      columns: [
        {
          name: "index",
          label: "#",
        ...
        },
        {
          name: "title",
          align: "left",
          label: "عنوان ویدیوی جلسه",
          field: (row) => row.periodMentorMediaId.title,
          sortable: true,
        },
        {
          name: "firstName",
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
          .get("periodMentorMediaComment", {headers: config})
          .then((response) => {
